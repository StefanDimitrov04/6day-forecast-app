...
createCardForDay = (cityName, cardForDay, index) => {
  ...
  <div class="icon">
  <img src="https://openweathermap.org/img/wn/${cardForDay.weather[0].icon}@4x.png" alt="weather-icon">
